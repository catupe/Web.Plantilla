...
<HEAD>
	...
	<link href="{$ruta_favicon}" rel="shortcut icon">
...
<body role="document">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
		  ...
		  <form class="navbar-form navbar-right"  method="post">
				<button type="submit" class="btn btn-sm btn-default" name="es" value="es"><span class="glyphicon glyphicon-flag" aria-hidden="true"></span>&nbsp;Espa&ntilde;ol</button>
				<button type="submit" class="btn btn-sm btn-default" name="en" value="en"><span class="glyphicon glyphicon-flag" aria-hidden="true"></span>&nbsp;Ingles</button>
		  </form>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <p>
		<h3>traduccion con smarty {$pepe}</h3>
		<br/>
		<button type="button" class="btn btn-lg btn-primary">{#base_hola#}</button>
        <button type="button" class="btn btn-lg btn-primary">{#base_chau#}</button>
	  </p>	
	  </br></br></br>
	  <p>
