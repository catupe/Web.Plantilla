...
function simple_php_captcha($config = array()) {
	...
	$bg_path = dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'web' . DIRECTORY_SEPARATOR . 'img' . DIRECTORY_SEPARATOR . 'captcha.backgrounds' . DIRECTORY_SEPARATOR;
	$font_path = dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'web' . DIRECTORY_SEPARATOR . 'fonts' . DIRECTORY_SEPARATOR;
